...
public class Bridge {
    ...
    public static void ShowToast(){
        Log.i("Unity", "Tipa tost))");
    }
    public static void StartRecording() {
        //android.widget.Toast.makeText(this, "Record started", Toast.LENGTH_SHORT).show();
        Log.i("Unity", "Start recording");
        MainActivity activity = (MainActivity)UnityPlayer.currentActivity;
        activity.OnStartRecording();
    }
    public static void StopRecording() {
        //android.widget.Toast.makeText(this, "Record stopped", Toast.LENGTH_SHORT).show();
        MainActivity activity = (MainActivity)UnityPlayer.currentActivity;
